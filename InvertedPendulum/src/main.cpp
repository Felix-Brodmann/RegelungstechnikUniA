...
int main()
{
    try
    {
        ...
        std::unique_ptr<control_engineering_uni_a::I2CDevice> i2cDevice = std::make_unique<control_engineering_uni_a::I2CDevice>("/dev/i2c-1", 0x68);

        // Create an LSM6DS3 IMU sensor using the builder pattern
        std::unique_ptr<control_engineering_uni_a::LSM6DS3> imuSensor =
            std::make_unique<control_engineering_uni_a::LSM6DS3>(
        ...
        std::unique_ptr<control_engineering_uni_a::EV3Motor> motor = 
            std::make_unique<control_engineering_uni_a::EV3Motor>(
                control_engineering_uni_a::EV3MotorBuilder::create()
                .setPwmDevice(std::move(pwmDevice))
        ...
        std::unique_ptr<control_engineering_uni_a::PIDRegulator> pidRegulator =
            std::make_unique<control_engineering_uni_a::PIDRegulator>(
