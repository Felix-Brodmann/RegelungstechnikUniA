...
public:
     ...
     * @return Reference to the PIDRegulatorBuilder instance for method chaining.
     */
    PIDRegulatorBuilder& setOutputMin(const SensorData outputMin)
    {
     ...
     * @return Reference to the PIDRegulatorBuilder instance for method chaining.
     */
    PIDRegulatorBuilder& setOutputMax(const SensorData outputMax)
    {
    ...
    std::unique_ptr<PIDRegulator> build()
    {
        ...
        {
            throw std::runtime_error("Minimum output value is not set");
        }
        if (!m_outputMax.has_value())
        {
            throw std::runtime_error("Maximum output value is not set");
        }
