...
public:
    ...
    void startRegulation() override
    {
        ...
        std::cout << "Starting regulation for " << getRegulatorName() << " with following parameters:" << std::endl;
        std::cout << "Kp: " << getKp() << std::endl;
        std::cout << "Ki: " << getKi() << std::endl;
        std::cout << "Kd: " << getKd() << std::endl;
        std::cout << "Setpoint: " << getSetpoint() << std::endl;
        std::cout << "Integral Min: " << getIntegralMin() << std::endl;
        std::cout << "Integral Max: " << getIntegralMax() << std::endl;
        std::cout << "Sampling Rate: " << getSamplingRate() << " Hz" << std::endl;
