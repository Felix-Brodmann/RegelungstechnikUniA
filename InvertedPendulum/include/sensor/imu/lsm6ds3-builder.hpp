...
{
private:
    std::unique_ptr<I2CDevice> m_i2cDevice; // I2C device used for communication with the sensor
...
public:
     ...
     * @param t_i2cDevice A unique pointer to the I2C device to be used for communication with the sensor.
