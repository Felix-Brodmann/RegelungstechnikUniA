...
public:
     ...
     */
    EV3Motor::EV3Motor(PwmDevice& t_pwmDevice, int t_forwardPin, int t_backwardPin,int t_tachoAPin, int t_tachoBPin) : Actuator("EV3Motor")
    {
        setPWMDevice(t_pwmDevice);
     ...
     */
    EV3Motor::EV3Motor() : Actuator("EV3Motor")
    {
     ...
     * @param t_pwmDevice The PWM device to be set.
     */
    void setPWMDevice(PwmDevice& t_pwmDevice)
    {
        setInitilizationStatus("pwmDevice", true);
        m_pwmDevice = t_pwmDevice;
    }
