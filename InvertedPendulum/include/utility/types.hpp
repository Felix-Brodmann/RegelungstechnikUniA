...
inline std::string toString(const int t_value)
{
    return std::to_string(t_value);
}

inline std::string toString(const double t_value)
{
    return std::to_string(t_value);
}
...
inline std::string toString(const Vector2D& vec)
{
...
inline std::string toString(const Vector3D& vec)
{
...
{
    return os << "IMUData{acceleration: " << imu.acceleration
              << ", gyroscope: " << imu.gyroscope
              << ", temperature: " << imu.temperature << "}";
}

inline std::string toString(const IMUData& imu)
{
    return "IMUData{acceleration: " + toString(imu.acceleration) +
           ", gyroscope: " + toString(imu.gyroscope) +
